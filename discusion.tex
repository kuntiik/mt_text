...
\section{Discusion}
% From the results in the chapter \ref{chapter:results}, we can see that the model is able to localize large portion of dental caries in the image, yet there are is a room for an improvement.

% \begin{itemize}
%     \item In the figure \ref{fig:yolov5_map_iou_thresholds} we can se sharp drop in the MAP values, when we choose IOU threshold greater than 0.4. The drop is in both training and validation MAP. This seems to be related to the data, rather than to the model. This matche
